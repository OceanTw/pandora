...
public class AbilityManager {
    ...
    private final Map<AbilityType, List<AbstractAbility>> abilitiesByType = new EnumMap<>(AbilityType.class);
     ...
     */
    public List<AbstractAbility> getAbilitiesByType(AbilityType type) {
